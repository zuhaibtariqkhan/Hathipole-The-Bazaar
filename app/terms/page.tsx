...
export default function TermsPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-12 md:py-16 space-y-10">
      ...
      {/* Main Container */}
      <div className="bg-[#FCFAF7] border border-[#D4AF37]/30 rounded-3xl p-6 sm:p-10 md:p-12 space-y-12 shadow-luxury text-xs sm:text-sm text-gray-700 leading-relaxed font-light">

        {/* SECTION I: TERMS & CONDITIONS */}
        <div className="space-y-10">
          <div className="border-b-2 border-[#D4AF37]/30 pb-4">
            <span className="font-cinzel text-xs text-[#D4AF37] tracking-widest font-bold uppercase block">Part I</span>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <FileText className="w-5 h-5 text-[#D4AF37] shrink-0" /> 1. Introduction
            </h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <UserCheck className="w-5 h-5 text-[#D4AF37] shrink-0" /> 2. Eligibility
            </h3>
          ...
          <section className="space-y-4">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <ShoppingBag className="w-5 h-5 text-[#D4AF37] shrink-0" /> 3. Products
            </h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Award className="w-5 h-5 text-[#D4AF37] shrink-0" /> 4. Authenticity
            </h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <DollarSign className="w-5 h-5 text-[#D4AF37] shrink-0" /> 5. Pricing
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <ShoppingBag className="w-5 h-5 text-[#D4AF37] shrink-0" /> 6. Orders
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <CreditCard className="w-5 h-5 text-[#D4AF37] shrink-0" /> 7. Payments
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Truck className="w-5 h-5 text-[#D4AF37] shrink-0" /> 8. Shipping
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Palette className="w-5 h-5 text-[#D4AF37] shrink-0" /> 9. Bespoke &amp; Made-to-Order Products
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Copyright className="w-5 h-5 text-[#D4AF37] shrink-0" /> 10. Intellectual Property
            </h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <AlertTriangle className="w-5 h-5 text-[#D4AF37] shrink-0" /> 11. User Conduct
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Scale className="w-5 h-5 text-[#D4AF37] shrink-0" /> 12. Limitation of Liability
            </h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <ShieldCheck className="w-5 h-5 text-[#D4AF37] shrink-0" /> 13. Warranties
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Lock className="w-5 h-5 text-[#D4AF37] shrink-0" /> 14. Privacy
            </h3>
            <p>
              Your use of the website is also governed by our{' '}
              <Link href="/privacy" className="text-[#D4AF37] font-semibold underline hover:text-[#1E1A18] transition-colors">
                Privacy Policy
              </Link>.
            </p>
          </section>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Building2 className="w-5 h-5 text-[#D4AF37] shrink-0" /> 15. Governing Law
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <RefreshCw className="w-5 h-5 text-[#D4AF37] shrink-0" /> 16. Changes to These Terms
            </h3>
          ...
          <section className="space-y-4 bg-[#F7F0E7] border border-[#D4AF37]/40 rounded-2xl p-6 sm:p-8">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/20 pb-2">
              <Mail className="w-5 h-5 text-[#D4AF37] shrink-0" /> 17. Contact Us
            </h3>
            <div className="space-y-2 text-xs sm:text-sm text-gray-800 font-normal">
              ...
              <p className="flex items-center gap-2 pt-1">
                ...
                <a href="mailto:team@hathipolethebazaar.com" className="text-[#D4AF37] hover:underline font-semibold">
        ...
        <div className="space-y-10 pt-8 border-t-2 border-[#D4AF37]/30">
          <div className="border-b-2 border-[#D4AF37]/30 pb-4">
            <span className="font-cinzel text-xs text-[#D4AF37] tracking-widest font-bold uppercase block">Part II</span>
            <h2 className="font-serif-luxury text-2xl sm:text-3xl font-bold text-[#1E1A18]">
          ...
          <section className="space-y-3 bg-[#241F1C] text-[#FCFAF7] rounded-2xl p-6 sm:p-8 border border-[#D4AF37]/40 shadow-xl">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#E6D2A8] flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-[#D4AF37]" /> Preserving India&apos;s Living Heritage
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Award className="w-5 h-5 text-[#D4AF37] shrink-0" /> Authentic Craftsmanship
            </h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Compass className="w-5 h-5 text-[#D4AF37] shrink-0" /> Curated Collections
            </h3>
            <p>Each product is carefully selected based on:</p>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-1 text-gray-800">
              <div className="flex items-center gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Authenticity
              </div>
              <div className="flex items-center gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Craftsmanship
              </div>
              <div className="flex items-center gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Material Quality
              </div>
              <div className="flex items-center gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Cultural Significance
              </div>
              <div className="flex items-center gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Artistic Excellence
              </div>
            </div>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Heart className="w-5 h-5 text-[#D4AF37] shrink-0" /> Artisan Support
            </h3>
            <p>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <ShieldCheck className="w-5 h-5 text-[#D4AF37] shrink-0" /> Quality Assurance
            </h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-gray-600">
              ...
              <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Material Integrity</div>
              <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Finishing</div>
              <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Packaging</div>
              <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Authenticity</div>
            </div>
            <p className="text-gray-600 pt-1">
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <BookOpen className="w-5 h-5 text-[#D4AF37] shrink-0" /> Heritage Documentation
            </h3>
          ...
          <section className="space-y-3">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Layers className="w-5 h-5 text-[#D4AF37] shrink-0" /> Care &amp; Preservation Guidance
            </h3>
            <p>
          ...
          <section className="space-y-4">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
              <Palette className="w-5 h-5 text-[#D4AF37] shrink-0" /> Bespoke Heritage Creations
            </h3>
            <p>
          ...
          {/* Our Promise */}
          <section className="space-y-4 bg-[#F5EFE6] border-2 border-[#D4AF37]/40 rounded-2xl p-6 sm:p-8 text-[#1E1A18]">
            <h3 className="font-serif-luxury text-xl sm:text-2xl font-bold flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-[#D4AF37]" /> Our Promise
            </h3>
            ...
            <p className="leading-relaxed font-semibold italic text-[#D4AF37] pt-1">
        ...
        <div className="pt-6 border-t border-[#D4AF37]/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link href="/privacy" className="px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-[#1E1A18] border border-[#D4AF37]/40 rounded-xl hover:bg-[#F7F0E7] transition-all">
              Privacy Policy
            </Link>
