...
export default function BespokePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-8 py-14 space-y-16">
      {/* Header Banner */}
      <div className="bg-[#1E1A18] text-[#FCFAF7] border border-[#D4AF37]/50 rounded-3xl p-10 md:p-16 text-center space-y-4 relative overflow-hidden shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="border-b border-[#D4AF37]/20 pb-4">
                <span className="font-cinzel text-xs tracking-wider text-[#D4AF37] uppercase block font-semibold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs p-3.5 bg-white border border-gray-300 rounded-xl focus:outline-none focus:border-[#D4AF37] transition-colors"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full text-xs p-3.5 bg-white border border-gray-300 rounded-xl focus:outline-none focus:border-[#D4AF37] transition-colors">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-[#1E1A18] text-[#FCFAF7] border border-[#D4AF37]/50 rounded-3xl p-8 space-y-6 shadow-2xl relative overflow-hidden">
            <h4 className="font-serif-luxury text-2xl font-bold text-[#E6D2A8] border-b border-[#D4AF37]/20 pb-3">
