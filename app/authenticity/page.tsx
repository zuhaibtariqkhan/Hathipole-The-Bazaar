  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 py-12 md:py-16 space-y-12">
      ...
      <div className="text-center space-y-4 border-b border-[#D4AF37]/30 pb-8">
        ...
        <p className="font-serif-luxury text-xl text-[#D4AF37] italic font-normal max-w-2xl mx-auto">
      ...
      <div className="bg-[#241F1C] border border-[#D4AF37]/40 rounded-3xl p-6 sm:p-8 text-[#FCFAF7] shadow-2xl space-y-6">
        <div className="text-center space-y-1">
          <span className="font-cinzel text-xs tracking-[0.2em] text-[#D4AF37] uppercase block font-semibold">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 pt-2">
          {trustBadges.map((badge) => {
            ...
            return (
              <div
                key={badge.title}
                className="bg-[#2A2421] border border-[#D4AF37]/25 rounded-2xl p-4 flex flex-col items-center text-center gap-2 hover:border-[#D4AF37] transition-all group"
              >
                <div className="w-10 h-10 rounded-xl bg-[#D4AF37]/15 border border-[#D4AF37]/40 flex items-center justify-center text-[#D4AF37] group-hover:bg-[#D4AF37] group-hover:text-[#1E1A18] transition-all">
      ...
      <div className="bg-[#FCFAF7] border border-[#D4AF37]/30 rounded-3xl p-6 sm:p-10 md:p-12 space-y-10 shadow-luxury text-xs sm:text-sm text-gray-700 leading-relaxed font-light">
        ...
        <section className="space-y-3">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <ShieldCheck className="w-5 h-5 text-[#D4AF37] shrink-0" /> Our Authenticity Promise
          </h2>
          <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
            <div className="flex items-start gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 p-3 rounded-xl text-xs text-gray-800">
        ...
        <section className="space-y-3">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <Users className="w-5 h-5 text-[#D4AF37] shrink-0" /> Direct Relationships with Artisans
          </h2>
          <p>
        ...
        <section className="space-y-4">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <Feather className="w-5 h-5 text-[#D4AF37] shrink-0" /> Handcrafted Means Every Piece is Unique
          </h2>
          <p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
            {uniqueVariations.map((item) => (
              <div key={item} className="bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs text-center font-medium text-gray-800">
                {item}
              </div>
            ))}
          </div>
          <p className="italic text-gray-800 border-l-2 border-[#D4AF37] pl-3 py-1 bg-[#F5EFE6]/50 rounded-r-lg font-normal">
        ...
        <section className="space-y-4">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <Sparkles className="w-5 h-5 text-[#D4AF37] shrink-0" /> Genuine Materials
          </h2>
          <p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 pt-1">
            {genuineMaterials.map((mat) => (
              <div key={mat} className="flex items-center gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs text-gray-800">
        ...
        <section className="space-y-4">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <Palette className="w-5 h-5 text-[#D4AF37] shrink-0" /> Traditional Techniques
          </h2>
          <p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 pt-1">
            {traditionalTechniques.map((tech) => (
              <div key={tech} className="flex items-center gap-2 bg-[#F7F0E7] border border-[#D4AF37]/20 px-3 py-2 rounded-xl text-xs text-gray-800">
                <CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37] shrink-0" />
                <span>{tech}</span>
              </div>
            ))}
        ...
        <section className="space-y-6 pt-4 border-t border-[#D4AF37]/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-3 pt-2">
            {craftJourneySteps.map((s, idx) => (
              <div
                key={s.step}
                className="bg-[#F7F0E7] border border-[#D4AF37]/30 rounded-2xl p-4 space-y-2 flex flex-col justify-between hover:border-[#D4AF37] hover:bg-[#F5EFE6] transition-all relative"
              >
                <div className="flex items-center justify-between">
                  <span className="font-cinzel font-bold text-base text-[#D4AF37]">{s.step}</span>
                  {idx < craftJourneySteps.length - 1 && (
                    <ArrowRight className="w-3.5 h-3.5 text-[#D4AF37]/40 hidden lg:block absolute -right-2.5 top-1/2 -translate-y-1/2 z-10" />
                  )}
                </div>
        ...
        <section className="space-y-3">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <Eye className="w-5 h-5 text-[#D4AF37] shrink-0" /> Quality Inspection
          </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-gray-600">
            <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Craftsmanship</div>
            <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Material Quality</div>
            <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Structural Integrity</div>
            <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Finish</div>
            <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Functionality</div>
            <div className="flex items-center gap-1.5"><span className="text-[#D4AF37]">•</span> Packaging</div>
          </div>
          <p className="text-gray-600 pt-1">
        ...
        <section className="space-y-3 bg-[#F5EFE6] border border-[#D4AF37]/30 rounded-2xl p-6">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/20 pb-2">
            <FileCheck className="w-5 h-5 text-[#D4AF37] shrink-0" /> Certificate of Authenticity
          </h2>
          <p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-gray-800 pt-1">
            <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Product Name</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Craft Tradition</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Region of Origin</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Material Details</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Artisan or Workshop</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-[#D4AF37]" /> Care Instructions</div>
          </div>
        ...
        <section className="space-y-3">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <Heart className="w-5 h-5 text-[#D4AF37] shrink-0" /> Ethical Sourcing
          </h2>
        ...
        <section className="space-y-3">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <ShieldAlert className="w-5 h-5 text-[#D4AF37] shrink-0" /> Counterfeit Protection
          </h2>
        ...
        <section className="space-y-3">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#1E1A18] flex items-center gap-2 border-b border-[#D4AF37]/15 pb-2">
            <BookOpen className="w-5 h-5 text-[#D4AF37] shrink-0" /> Caring for Handmade Products
          </h2>
        ...
        {/* 12. Our Commitment */}
        <section className="space-y-4 bg-[#241F1C] text-[#FCFAF7] rounded-2xl p-6 sm:p-8 border border-[#D4AF37]/40 shadow-xl">
          <h2 className="font-serif-luxury text-xl sm:text-2xl font-bold text-[#E6D2A8] flex items-center gap-2">
            <Sparkles className="w-5 h-5 text-[#D4AF37]" /> Our Commitment
          </h2>
          ...
          <div className="pt-2 border-t border-[#D4AF37]/30 space-y-1 font-serif-luxury text-[#E6D2A8] italic text-base">
        ...
        <div className="pt-6 border-t border-[#D4AF37]/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link href="/artisans" className="px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-[#1E1A18] border border-[#D4AF37]/40 rounded-xl hover:bg-[#F7F0E7] transition-all">
